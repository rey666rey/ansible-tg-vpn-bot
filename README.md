...
Кнопка `♻️ пересоздать пользователя` удаляет клиента из всех inbound-ов на всех
серверах из sqlite, создает его заново и возвращает новые обычную и Clash/Mihomo
сабки с новым random `subId`.
